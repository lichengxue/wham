# Function to specify movement rate      
generate_move <- function(basic_info = basic_info, 
  ...
  fracyr_spawn = basic_info$fracyr_spaw
  ...
  if (is.null(move.re)) move.re = "constant"
