...
#### Fig.1 Performance of different assessment models from a single realization
![Fig.1](https://github.com/lichengxue/wham/blob/mse/mse_vignettes/Vignettes_figs/Performance_Metrics_one_realization.PNG)
...
## 11. Generate Replicates and Parallel Computing
```r
...
folder.name = "Project0_Scenario1"
sub.dir <- folder.name
if (file.exists(file.path(main.dir,sub.dir))){
  setwd(file.path(main.dir,sub.dir))
} else {
...
cluster <- makeCluster(detectCores()-2) # detectCores() can check number of cores
...
res = list()
for (nsim in 1:40){
  mod.list <- paste0("Mod_",i,sprintf("_%03d.RDS",nsim))
  mods <- lapply(mod.list, readRDS)
  res[[nsim]] <- mods
}
````
### Plot MSE output
The plot_mse_output() function can summarize the results over 50 realizations
```r
plot_mse_output(mods = res, use.n.years = 15)
````

#### Fig.1 SSB, catch, and F over the last 15 years
![Fig.1](https://github.com/lichengxue/wham/blob/mse/mse_vignettes/Vignettes_figs/Performance_last_15years.PNG)
#### Fig.2 Relative difference in SSB, catch, and F over the last 15 years
![Fig.2](https://github.com/lichengxue/wham/blob/mse/mse_vignettes/Vignettes_figs/Performance_last_15years_bias.PNG)
#### Fig.3 Relative difference in SSB, catch, and F over a short term (first 3 years) 
![Fig.3](https://github.com/lichengxue/wham/blob/mse/mse_vignettes/Vignettes_figs/Performance_first_3years_bias.PMG)
#### Fig.4 Performance radar chart
![Fig.4](https://github.com/lichengxue/wham/blob/mse/mse_vignettes/Vignettes_figs/Radar_chart_last_15years.PNG)
#### Fig.5 Stock status over the last 15 years (boxplot)
![Fig.5](https://github.com/lichengxue/wham/blob/mse/mse_vignettes/Vignettes_figs/Stock_Status_Performance_last_15years.PNG)
#### Fig.6 Stock status over the last 15 years (scatter plot)
![Fig.6](https://github.com/lichengxue/wham/blob/mse/mse_vignettes/Vignettes_figs/Stock_Status_Performance_last_15years_all.PNG)
#### Fig.7 Stock status over the last 15 years (Median with IQR)
![Fig.7](https://github.com/lichengxue/wham/blob/mse/mse_vignettes/Vignettes_figs/Population_Status_last_15years_median.PNG)
#### Fig.8 AIC (only terminal year assessment model is used)
![Fig.8](https://github.com/lichengxue/wham/blob/mse/mse_vignettes/Vignettes_figs/AIC.PNG)
#### Fig.9 Estimated mean recruitment (only terminal year assessment model is used)
![Fig.9](https://github.com/lichengxue/wham/blob/mse/mse_vignettes/Vignettes_figs/Mean_rec_par.PNG)
#### Fig.10 Estimated variance parameters for NAA random effects (only terminal year assessment model is used)
![Fig.10](https://github.com/lichengxue/wham/blob/mse/mse_vignettes/Vignettes_figs/Variance_Para_NAA.PNG)