...
# 3. "dirichlet-miss0",
# 4. "dirichlet-pool0",
# 5. "logistic-normal-miss0",
# 6. "logistic-normal-ar1-miss0",
# 7. "logistic-normal-pool0",
# 8. "logistic-normal-01-infl",
# 9. "logistic-normal-01-infl-2par",
# 10."mvtweedie",
# 11."dir-mult-linear" 
...
sim_fn <- function(om, self.fit = FALSE){
  ...
  if(self.fit) {
    input <- set_age_comp(input, age_comp = age_comp)
