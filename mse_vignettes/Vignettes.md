...
#### 2. Type "cd directory" here replace "directory" with a specific path to save the package (you can also skip this step and the package will be saved in the main directory). 
